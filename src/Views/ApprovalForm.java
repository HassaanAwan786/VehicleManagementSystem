...
public class ApprovalForm extends javax.swing.JFrame {
    ...
    public ApprovalForm() {
        initComponents();
        autoID = 0;
        personController = new Person_Controller();
        roleController = new RoleController();
        ArrayList<Role> list = roleController.getRolesFromList();
        for (Role role : list) {
            roleSet.addItem(role.getName());
        }
    }
    ...
    private void initComponents() {
        ...
        moveToFirst.setText("<<");
        moveToFirst.addActionListener(this::moveToFirstActionPerformed);

        moveToLast.setText(">>");
        moveToLast.addActionListener(this::moveToLastActionPerformed);

        moveOneLeft.setText("<");
        moveOneLeft.addActionListener(this::moveOneLeftActionPerformed);

        moveOneRight.setText(">");
        moveOneRight.addActionListener(this::moveOneRightActionPerformed);
...
//            setFieldsFromListAt(0);
    ...
    private void deleteRoleActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteRoleActionPerformed
        ...
        if(personController !=null){
                personController.delPerson(currentPosition);
                resetFields();
        }
        resetFields();
        currentStatus.setText("0");
        currentPosition =0;
        if(personController !=null && personController.getSizeApproval(this)!=0){
    ...
    private void findRoleActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_findRoleActionPerformed
        ...
        saveSuccess.setText("");
        if(personController !=null){
            int position = personController.searchPerson(nameField.getText());
            if(position!=-1){
    ...
    private void moveOneRightActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_moveOneRightActionPerformed
        // TODO add your handling code here:
        if(personController !=null){
            if(currentPosition!= personController.getSizeApproval(this)-1){
                currentPosition++;
            }
            setFieldsFromListAt(currentPosition);
            currentStatus.setText(currentPosition+"");
    ...
    private void moveToLastActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_moveToLastActionPerformed
        // TODO add your handling code here:
        if(personController !=null){
            currentPosition = personController.getSizeApproval(this)-1;
            currentStatus.setText(currentPosition+"");
            setFieldsFromListAt(currentPosition);
        }
        saveSuccess.setText("");
